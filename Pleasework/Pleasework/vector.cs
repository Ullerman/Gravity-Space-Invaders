        ...
        public class Line
        {
            ...
            public void Draw(SpriteBatch spriteBatch, PrimitiveBatch primitiveBatch, Vector2 CameraOffset)
            {
                ...
                spriteBatch.Draw(
                    ...
                    new Rectangle((int)(Start.X+CameraOffset.X), (int)(Start.Y+CameraOffset.Y), (int)edge.Length(), (int)Width),
                    null,
                    Color,
                    angle,
                    Vector2.Zero,
        ...
        public class Circle
        {
            ...
            public void Draw(SpriteBatch spriteBatch, PrimitiveBatch primitiveBatch, Vector2 CameraOffset)
            {
                spriteBatch.Draw(
                    ...
                    Color,
                    0,
                    new Vector2(primitiveBatch.WhiteCircle.Width/2, primitiveBatch.WhiteCircle.Height/2),
                    new Vector2(Radius/primitiveBatch.WhiteCircle.Width, Radius/primitiveBatch.WhiteCircle.Height),
                    SpriteEffects.None,
                    0
                );
            }
